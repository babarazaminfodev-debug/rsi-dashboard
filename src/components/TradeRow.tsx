  ...
  if (trade.status === TradeStatus.OPEN) {
    return (
      <tr className="border-b border-gray-700/50 hover:bg-gray-800/60">
        ...
        <td className="p-3 text-gray-400 text-sm hidden lg:table-cell">{new Date(trade.openedAt).toLocaleTimeString()}</td>
      </tr>
    );
  }
  ...
  return (
      <tr className="border-b border-gray-700/50 hover:bg-gray-800/60 opacity-70">
        ...
        <td className="p-3 text-gray-400 text-sm hidden lg:table-cell">
            {trade.closedAt ? formatDuration(new Date(trade.openedAt), new Date(trade.closedAt)) : '-'}
        </td>
      </tr>
  );
<<<<<<< HEAD
